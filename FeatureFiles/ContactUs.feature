...
Scenario: Contact customer service
    ...
    #-------Uncomment below code for verifying success message (CAPTCHA is blocking at the moment)---------

    #Then User Verify the success message "Thank you for getting in touch with us."