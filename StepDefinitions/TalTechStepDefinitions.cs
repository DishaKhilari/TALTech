...
namespace TalTechWebUIAutomation.StepDefinitions
{
    ...
    public sealed class TalTechStepDefinitions
    {
        ...
        public void GivenINavigateToTheTALWebsite()
        {
            // Geting the website URL from appsettings.json
        ...
        public void ThenUserVerifyTheSucessMessage(string successMessage)
        {
            _mainPage.SuccessMessage(successMessage);
        }
